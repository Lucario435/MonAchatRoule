    ...
    <body>
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-sm-8 text-start fs-5 mt-2 mb-4">
                    <p>
                        MonAchatRoule a pour mission de connecter les acheteurs d'automobile aux bons vendeurs.
                        On propose un système d'enchères permettant au vendeur de vendre au meilleur offrant.
                        Les utilisateurs pourront trouver la voiture qui répond à leurs critères rapidement grâce à notre
                        sytème de recherche.
                        Les deux parties profiteront de notre messagerie en temps réel pour que leur expérience de vente ou
                        de magasinage soit complète.
                    </p>
                </div>
