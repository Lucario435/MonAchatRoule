...
@section('content')
    ...
    <div class="filters-container">
        ...
        <div class="filters-controls">
            <button class="buttonEffect" type="button" onclick="alert('Filtre en cours')">Filtrer par prix</button>
            <button class="buttonEffect" type="button" onclick="alert('Filtre en cours')">Filtrer par marque</button>
            <button class="buttonEffect" type="button" onclick="alert('Filtre en cours')">Filtrer par kilometre</button>
            <button class="buttonEffect" type="button" onclick="alert('Filtre en cours')">Filtrer par titre</button>
            <button class="buttonEffect" type="button" onclick="alert('Filtre en cours')">Filtrer par kilometre</button>
            <button class="buttonEffect" type="button" onclick="alert('Filtre en cours')">Filtrer par test</button>
            <button class="buttonEffect" type="button" onclick="alert('Filtre en cours')">Filtrer par kilometre</button>
            <button class="buttonEffect" type="button" onclick="alert('Filtre en cours')">Filtrer par couleur</button>
